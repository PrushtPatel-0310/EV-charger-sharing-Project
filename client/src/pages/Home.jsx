...
const Home = () => {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary-600 to-primary-800 text-white py-14 sm:py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="mx-auto mb-6 max-w-3xl text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">
            Share Your EV Charger, Power the Future
          </h1>
          <p className="mx-auto mb-8 max-w-2xl text-base text-primary-100 sm:text-lg lg:text-xl">
